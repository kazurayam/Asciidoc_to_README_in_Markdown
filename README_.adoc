...
Name your Asciidoc document as `README_.adoc` with a meaningless underbar character appended. The `readmeconv.sh` script can convert the `README_.adoc` file into `README.md`, and GitHub will happily surface the generated `README.md` to us. 
